 ...
 * @author Yoselin
 */
public class AdministrarProductosAdmi extends javax.swing.JFrame {

    /**
     * Creates new form vistaAdministrarUsuarios
     */
    public AdministrarProductosAdmi() {
        initComponents();
...
//        this.setVisible(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdministrarProductosAdmi.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdministrarProductosAdmi().setVisible(true);
            }
        });
    }
